...
int main(int argc, char **argv) {
    ...
    /*
     * Only root allocates the FULL array now.
    ...
    /*
     * SCATTER: Root splits the array into equal chunks and sends
     * ONE chunk to each process (root keeps a chunk for itself too).
     * sendcount is the number of elements sent to EACH process, not N.
     */
    ...
    printf("  Rank %d: summed local chunk of size %d => local_sum = %lld\n",
